...
# checkpoint
filepath='2fre4time_SNR20_time4_16_4_200ep.keras'
...
model.fit(H_train_noisy, H_train, epochs=30, batch_size=32, callbacks=callbacks_list, verbose=2, shuffle=True, validation_split=0.1)
print("H_train_noisy shape = ", H_train_noisy.shape, ", H_train shape = ", H_train.shape)

# load model
CNN = load_model('2fre4time_SNR20_time4_16_4_200ep.keras')
